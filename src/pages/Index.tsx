...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden border-b-2 border-vintage-burgundy/30 bg-vintage-paper py-12 md:py-20">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <div className="mb-4 md:mb-6 p-4 md:p-6 bg-vintage-paper rounded-full border-2 md:border-4 border-vintage-burgundy shadow-lg">
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center p-4 md:p-6 ornate-border bg-vintage-paper">
            ...
            <div className="text-center p-4 md:p-6 ornate-border bg-vintage-paper sm:col-span-2 lg:col-span-1">
              <div className="flex justify-center mb-3 md:mb-4">
                <div className="p-3 md:p-4 bg-vintage-burgundy/10 rounded-full">
      ...
      <section className="py-12 md:py-16 border-t-2 border-vintage-burgundy/30 bg-vintage-paper">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-vintage-burgundy mb-4 md:mb-6 text-shadow-vintage px-4">
